...
export const PHENOM_INTENRSHIP = {
  TITLE: "Product Development Engineer I Intern",
  COMPANY: "Phenom",
  START_DATE: "Jan 2022",
  END_DATE: "April 2022",
  DESCRIPTION:
...
export const SCALER = {
  ...
  END_DATE: "Present",
  DESCRIPTION:
    "Developed and maintained Phenom’s SaaS product suite, including APM, QA Hub, and App Trail.",
  SKILLS: [
    "React.js",
    "Java",
    "Spring Boot",
...
export const NMREC = {
  ...
  COMPANY: "Nalla Malla Reddy Engineering College",
  START_DATE: "Aug 2016",
  END_DATE: "Dec 2020",
  LOCATION: "Hyderabad",
};
